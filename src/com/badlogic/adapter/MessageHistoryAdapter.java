...
public class MessageHistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.leftLayout = (LinearLayout) view.findViewById(R.id.ll_left_chat_item);
            viewHolder.rightLayout = (LinearLayout) view.findViewById(R.id.ll_right_chat_item);
            viewHolder.rightImageContent = (ImageView) view.findViewById(R.id.iv_right_avatar);
