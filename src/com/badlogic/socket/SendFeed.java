...
public class SendFeed extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emotionStaticAdapter = new EmotionStaticAdapter(this.getApplicationContext(), DataProvider.imageRes);
        mEmoticons.setAdapter(emotionStaticAdapter);
        messageHistoryList = getData();
        messageHistoryAdapter = new MessageHistoryAdapter(this.getApplicationContext(), messageHistoryList);
    ...
    private void setListeners() {
        ...
        mPublish.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mContent.getText().toString().trim().length() == 0) {
                    Toast.makeText(SendFeed.this, R.string.content_empty, Toast.LENGTH_SHORT).show();
                } else {
        ...
        mEmoticon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mEmoticons.isShown()) {
                    ...
                    ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE)).hideSoftInputFromWindow(SendFeed.this.getCurrentFocus()
